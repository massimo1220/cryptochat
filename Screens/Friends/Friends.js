...
export default class Friends extends Component {
  ...
  handleSendRequest = async (to) => {
    ...
    } catch(error) { this.setState({ error: 'Si è verificato un problema durante l\'invio della richiesta di amicizia' }) }
  }
  ...
  clearRequest = async (email) => {
    ...
    } catch(error) { this.setState({ error: 'Impossibile eliminare la richiesta di amicizia' }) }
  }
      ...
      <View style={styles.container}>
        ...
        <Modal visible={showConfirmDeleteFriend} animationType="slide" onRequestClose={() => this.setState({ showConfirmDeleteFriend: false })}>
          <View style={styles.deleteFriendContainer}>
            <Text style={styles.text}>Sei sicuro di voler eliminare {selectedFriend}?</Text>
            <TouchableOpacity style={styles.button} onPress={() => this.deleteFriend(selectedFriend)}><Text style={styles.buttonText}>Si</Text></TouchableOpacity>
